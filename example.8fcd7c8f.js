...
var _default = {
  ...
  mounted: function mounted() {
    var scrollEl = this.$refs.main;
    var els = document.querySelectorAll('.card-title');

    var _scrollEl$getBounding = scrollEl.getBoundingClientRect(),
        top = _scrollEl$getBounding.top;
  ...
  methods: {
    handleScroll: function handleScroll(evt) {
      var value = evt.currentTarget.scrollTop - 10;
      var index = this.offset.findIndex(function (v) {
        return v > value;
      });
...
exports.default = _default;
      ...
      if (typeof $617eab === 'function') {
        ...
        Object.assign($617eab, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container"},[_c('div',{staticClass:"sidebar"},_vm._l((_vm.menus),function(menu,i){return _c('a',{key:menu.id,class:{ active: _vm.activeIndex === i },attrs:{"href":("#" + (menu.id))}},[_vm._v(_vm._s(menu.title))])}),0),_vm._v(" "),_c('div',{ref:"main",staticClass:"main",on:{"scroll":_vm.handleScroll}},[_c('div',{staticClass:"content"},[_vm._t("default")],2)])])}
var staticRenderFns = []
...
var titleAndDescMap = transformMd(_en.default);
var App = {
  name: 'App',
  mounted: function mounted() {
...
var _default = App;
exports.default = _default;
},{"fs":"rDCW","highlight.js/lib/highlight":"R7gn","highlight.js/lib/languages/javascript":"YrXX","highlight.js/lib/languages/xml":"ElH3","highlight.js/styles/atom-one-light.css":"rDCW","./helper/container.vue":"exOZ","./helper/card.vue":"K2WH","./demo/Basic.vue":"F4k5","./demo/ValueType.vue":"MAVg","./demo/Range.vue":"vssy","./demo/DisabledDateTime.vue":"tBXd","./demo/Shortcut.vue":"U8rn","./demo/ControlTimePanel.vue":"jkBQ","./demo/ControlOpen.vue":"hLWH","./demo/HideSeconds.vue":"P315","./demo/MinuteStep.vue":"WCZR","./demo/FixedTimeList.vue":"hxWp","./demo/Disabled.vue":"TYGO","./en.md":"yxg7"}],"Focm":[function(require,module,exports) {
"use strict";
...
var b=require("TUK3");b.register("html",require("A3BY"));b.load([["en.ba2e3834.html","yxg7"]]).then(function(){require("Focm");});
},{}]},{},[0], null)